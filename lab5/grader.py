...
RUBRIC = [
          ("Task 1: Make order from line", "mk_order_from_line", 15.0),
          ("Task 2: To string order", "to_string_order", 10.0),
          ("Task 3: Find before", "find_before", 20),
          ("Task 4: Add order", "add_order_list", 15),
          ("Task 6: Remove order by oref", "remove_order_by_oref", 20),    
