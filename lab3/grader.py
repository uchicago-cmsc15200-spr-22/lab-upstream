...
RUBRIC = [
          ("Task 1: Count Occurrences", "count_occurrences", 15.0),
          ("Task 2: Div and mod", "div_and_mod", 15.0),
          ("Task 3: Find first last occurrence", "find_first_last_occurrence", 20.0),    
          ("Task 4: Compute frequencies", "compute_frequencies", 15.0),
          ("Task 5: Max Frequency", "freq_max", 15.0),    
         ]
