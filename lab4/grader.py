...
RUBRIC = [
          ("Task 1: Match at index", "match_at_index", 15.0),
          ("Task 2: Count occurrences", "count_occurrences", 15.0),
          ("Task 3: Count_non_overlapping", "count_non_overlapping", 15.0),    
          ("Task 4: Compare pairs", "compare_pairs", 20.0),
          ("Task 5: Find match", "find_match", 15.0),    
         ]
