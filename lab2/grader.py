...
RUBRIC = [
          ("Task 1: Compute Division Fraction", "compute_div_fraction", 20.0),
          ("Task 2: In Range #1", "in_range_1", 10.0),
          ("Task 3: In Range #2", "in_range_2", 10.0),    
          ("Task 4: Clip", "clip", 10.0),
          ("Task 5: Extract Flag", "extract_flag", 10.0),    
         ]
